...
setup(
  ...
  download_url = 'https://github.com/BoGs567/yahoo-finance-data/archive/refs/tags/0.0.8.tar.gz',   
  keywords = ['Yahoo', 'finance', 'data', 'Financial', 'finance','yahoo finance', 'yahoo-finance', 'yahoo data','yahoo finance data', 'yahoo-finance-data'],   # Keywords that define your package best
  install_requires=['requests','certifi','urllib3','beautifulsoup4','datetime'],
  classifiers=[
